...
public class AndroidAssetsLocator implements AssetLocator {

    private static final Logger logger = Logger.getLogger(AndroidAssetsLocator.class.getName());

    private String rootPath = "";

    public AndroidAssetsLocator() {
    }
